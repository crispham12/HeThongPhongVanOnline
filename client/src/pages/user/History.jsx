            ...
            <div className="bg-white rounded-2xl w-full max-w-[480px] p-6 shadow-xl border border-gray-100">
              ...
              <div className="flex items-center justify-end gap-3 border-t border-gray-100 pt-5 mt-6">
                ...
                <button
                  ...
                  disabled={deleting}
                  className="px-5 py-2 bg-blue-600 border border-transparent rounded-lg text-[13px] font-bold  hover:bg-[#9de675] transition-colors shadow-sm disabled:opacity-50">
